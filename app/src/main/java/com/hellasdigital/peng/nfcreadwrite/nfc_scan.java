...
public class  nfc_scan extends MainActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        btntwo = (Button) findViewById(R.id.btn_delete_user);
        btntwo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Vibrator v1 = (Vibrator) getSystemService(Context.VIBRATOR_SERVICE);
                v1.vibrate(400);
                Intent deleteIntent = new Intent(nfc_scan.this, delete_user.class);
            ...
            public void onClick(View v) {
                ...
                try {
                    if (myTag == null) {
                        ...
                        write(encryption(message.getText().toString()), myTag);
